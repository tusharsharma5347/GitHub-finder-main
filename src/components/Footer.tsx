...
export default function Footer() {
  return (
    <footer
      ...
      <div
        className="relative bottom-0 flex items-center justify-center border-b-2 border-neutral-200 p-6 dark:border-neutral-500 lg:justify-between">
      ...
      <div className="relative mx-6 py-8 text-center md:text-left">
        <div className="grid-1 grid gap-2 md:grid-cols-2 lg:grid-cols-4">
          <div className="">
            ...
            <p className='font-semibold'>
              Your go to destination for hackathons!
            </p>
          </div>
          <div className="">
            <p 
